...
| [home.md](./home.md) | 홈(지도뷰) — 검색·칩·필터·바텀시트·매장목록 | 실시간 데이터(4만 매장) + 서버 필터(q·정렬·8종·slot_date) 완료 / 시간필터는 백엔드 슬롯 API 수정 대기 |
| [shop-detail.md](./shop-detail.md) | 샵 상세 — 헤더·캐러셀·탭(스크롤스파이)·빈자리·메뉴·정보·리뷰·예약바 | 실데이터(메뉴·리뷰·도로명·다중사진) 완료 / 빈자리는 백엔드 슬롯 API 수정 대기 |
